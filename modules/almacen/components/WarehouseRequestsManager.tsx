...
export function WarehouseRequestsManager() {
  ...
  return <div className="space-y-5">
    <div className="rounded-xl border border-slate-200 bg-white p-5 flex flex-wrap items-center justify-between gap-3">
      <div><h1 className="text-xl font-bold text-slate-800">Solicitudes de almacén</h1><p className="text-xs text-slate-500">El almacenista solicita; el administrador aprueba y aplica el movimiento.</p></div>
