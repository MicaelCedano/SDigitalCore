...
type ShipmentForm = { title: string; destination: string; destinationAddressId: string; driverId: string; notes: string };

export function ShipmentsManager({ initialShipments, drivers, addresses, currentUserId }: Props) {
  const emptyForm = (): ShipmentForm => ({ title: "", destination: "", destinationAddressId: "", driverId: "", notes: "" });
