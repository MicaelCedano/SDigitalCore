...
const vehicleIcon = L.divIcon({ className: "shipment-vehicle-icon", html: '<div style="width:34px;height:34px;border-radius:50%;background:#4f46e5;border:4px solid white;box-shadow:0 5px 18px rgba(15,23,42,.35);display:flex;align-items:center;justify-content:center;font-size:17px">🚚</div>', iconSize: [34, 34], iconAnchor: [17, 17] });
