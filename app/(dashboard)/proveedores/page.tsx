...
export default function Page() {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "60vh", gap: 20, textAlign: "center" }}>
      ...
      <h1 style={{ fontSize: "1.5rem", fontWeight: 700, color: "#fbbf24", margin: 0 }}>Proveedores</h1>
      <p style={{ color: "var(--text-secondary)", margin: 0, maxWidth: 380 }}>Catálogo de proveedores, contactos y estados.</p>
